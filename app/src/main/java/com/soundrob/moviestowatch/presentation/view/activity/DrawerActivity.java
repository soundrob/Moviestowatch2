package com.soundrob.moviestowatch.presentation.view.activity;
...
import com.soundrob.moviestowatch.presentation.presenter.DrawerPresenter;
import com.soundrob.moviestowatch.presentation.view.fragment.FragmentNavigator;
...
import static com.soundrob.moviestowatch.R.id.toolbar;
...
public class DrawerActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        presenter.onViewCreated(DrawerProxyView);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        presenter.onMenuItemSelected(int id);
